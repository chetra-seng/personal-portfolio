...
const Header: React.FC<Props> = ({ items }) => {
  ...
  return (
    <header className="relative z-999">
      <motion.div
        className="fixed left-1/2 top-0 h-18 w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] dark:border-black/40 dark:bg-gray-950 dark:bg-opacity-75 sm:top-6 sm:h-13 sm:w-xl sm:rounded-full"
        initial={{
          x: "-50%",
          y: -100,
          opacity: 0,
